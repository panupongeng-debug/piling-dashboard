...
if __name__ == '__main__':
    ...
    print()
    print("💡 Tips:")
    print("  1. Edit Excel file normally")
    print("  2. Run: python update_pile_dashboard.py")
    print("  3. Browser will auto-refresh (or click Refresh button)")
    print()
